        ...
        <div className="d-flex">
            ...
            <div className={`sidebar bg-light ${sidebarOpen ? 'open' : ''}`} style={{ width: sidebarOpen ? "250px" : "70px", transition: "width 0.3s" }}>
                ...
                <nav className="d-flex flex-column p-4">
                    ...
                    <Link to="/student/dashboard" className="text-decoration-none text-dark fs-5 mb-3 d-flex align-items-center">
                        <i className="bi bi-align-top me-2"></i>{sidebarOpen && "StudentReg"}
                    </Link>
                    <Link to="/admin/signup" className="text-decoration-none text-dark fs-5 mb-3 d-flex align-items-center">
                        <i className="bi bi-align-top me-2"></i>{sidebarOpen && "AdminReg"}
                    </Link>
                    <Link to="/teacher/signup" className="text-decoration-none text-dark fs-5 mb-3 d-flex align-items-center">
                        <i className="bi bi-align-top me-2"></i>{sidebarOpen && "TeacherReg"}
                    </Link>
